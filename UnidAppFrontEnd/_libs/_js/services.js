...
.factory("s_anuncios_g", function($resource){
	...
	return $resource("https://unidapp-ds.dal.jelastic.vps-host.net/ROOT/UnidAppBackEnd/Slim-2.6.2/anunciosgen/", {update: {method: "PUT"}});
})
.factory("s_criterios", function($resource){
	...
	return $resource("https://unidapp-ds.dal.jelastic.vps-host.net/ROOT/UnidAppBackEnd/Slim-2.6.2/criterio/", {update: {method: "PUT"}});
})
.factory("s_anuncios_a", function($resource){
	...
	return $resource("https://unidapp-ds.dal.jelastic.vps-host.net/ROOT/UnidAppBackEnd/Slim-2.6.2/anunciosadmin/", {update: {method: "PUT"}});
})
